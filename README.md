...
The PWA (Progressive Web App) support is disabled by default. One of the main components of a PWA is a service worker.
...
To build the final jar and optimize the incidents application for production, run:
